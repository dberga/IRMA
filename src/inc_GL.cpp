...
/****************************************************************************************************************************/
	...
	void OpenGLWindow::ReSizeGLScene()		// Resize And Initialize The GL Window
	{
	...
	void OpenGLWindow::KillGLWindow(void)				// Properly Kill The Window
	{
		...
		if (hRC)											// Do We Have A Rendering Context?
		{
			...
			{
				MessageBox(NULL,(LPCSTR)(LPCSTR)(LPCWSTR)"Release Of DC And RC Failed.",(LPCSTR)(LPCSTR)(LPCWSTR)"SHUTDOWN ERROR",MB_OK | MB_ICONINFORMATION);
			}

			if (!wglDeleteContext(hRC))						// Are We Able To Delete The RC?
			{
				MessageBox(NULL,(LPCSTR)(LPCWSTR)"Release Rendering Context Failed.",(LPCSTR)(LPCWSTR)"SHUTDOWN ERROR",MB_OK | MB_ICONINFORMATION);
			}
		...
		{
			MessageBox(NULL,(LPCSTR)(LPCWSTR)"Release Device Context Failed.",(LPCSTR)(LPCWSTR)"SHUTDOWN ERROR",MB_OK | MB_ICONINFORMATION);
			hDC=NULL;										// Set DC To NULL
		}

		if (hWnd && !DestroyWindow(hWnd))					// Are We Able To Destroy The Window?
		{
			MessageBox(NULL,(LPCSTR)(LPCWSTR)"Could Not Release hWnd.",(LPCSTR)(LPCWSTR)"SHUTDOWN ERROR",MB_OK | MB_ICONINFORMATION);
			hWnd=NULL;										// Set hWnd To NULL
		}

		if (!UnregisterClass((LPCSTR)(LPCWSTR)"OpenGL",hInstance))			// Are We Able To Unregister Class
		{
			MessageBox(NULL,(LPCSTR)(LPCWSTR)"Could Not Unregister Class.",(LPCSTR)(LPCWSTR)"SHUTDOWN ERROR",MB_OK | MB_ICONINFORMATION);
	...
	BOOL OpenGLWindow::CreateGLWindow()
	{
		...
		wc.lpszClassName	= (LPCSTR)(LPCWSTR)"OpenGL";	// Set The Class Name

		::TlsSetValue(s_tlsIndex, this);

		if (!RegisterClass(&wc))									// Attempt To Register The Window Class
		{
			MessageBox(NULL,(LPCSTR)(LPCWSTR)"Failed To Register The Window Class.", (LPCSTR)(LPCWSTR)"ERROR",MB_OK|MB_ICONEXCLAMATION);
		...
		if (!(hWnd=CreateWindowEx(	dwExStyle,							// Extended Style For The Window
									...
									(LPCSTR)(LPCWSTR)title,								// Window Title
									...
									NULL)))								// Dont Pass Anything To WM_CREATE
		{
			...
			MessageBox(NULL,(LPCSTR)(LPCWSTR)"Window Creation Error.",(LPCSTR)(LPCWSTR)"ERROR",MB_OK|MB_ICONEXCLAMATION);
			return FALSE;								// Return FALSE
		}
		...
		{
			KillGLWindow();								// Reset The Display
			MessageBox(NULL,(LPCSTR)(LPCWSTR)"Can't Create A GL Device Context.",(LPCSTR)(LPCWSTR)"ERROR",MB_OK|MB_ICONEXCLAMATION);
			return FALSE;								// Return FALSE
		}
		...
		{
			KillGLWindow();								// Reset The Display
			MessageBox(NULL,(LPCSTR)(LPCWSTR)"Can't Find A Suitable PixelFormat.",(LPCSTR)(LPCWSTR)"ERROR",MB_OK|MB_ICONEXCLAMATION);
			return FALSE;								// Return FALSE
		}
		...
		{
			KillGLWindow();								// Reset The Display
			MessageBox(NULL,(LPCSTR)(LPCWSTR)"Can't Set The PixelFormat.",(LPCSTR)(LPCWSTR)"ERROR",MB_OK|MB_ICONEXCLAMATION);
			return FALSE;								// Return FALSE
		}
		...
		{
			KillGLWindow();								// Reset The Display
			MessageBox(NULL,(LPCSTR)(LPCWSTR)"Can't Create A GL Rendering Context.",(LPCSTR)(LPCWSTR)"ERROR",MB_OK|MB_ICONEXCLAMATION);
			return FALSE;								// Return FALSE
		}
		...
		{
			KillGLWindow();								// Reset The Display
			MessageBox(NULL,(LPCSTR)(LPCWSTR)"Can't Activate The GL Rendering Context.",(LPCSTR)(LPCWSTR)"ERROR",MB_OK|MB_ICONEXCLAMATION);
			return FALSE;								// Return FALSE
		}
		...
		{
			KillGLWindow();								// Reset The Display
			MessageBox(NULL,(LPCSTR)(LPCWSTR)"Initialization Failed.",(LPCSTR)(LPCWSTR)"ERROR",MB_OK|MB_ICONEXCLAMATION);
			return FALSE;								// Return FALSE
		}
